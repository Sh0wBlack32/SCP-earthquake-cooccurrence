...
cloud reali a 2 worker (n2-standard-4, memoria tunata come sopra), pilotati direttamente da Claude
autenticato via OAuth nel proprio ambiente cloud (comandi `gcloud` eseguiti in autonomia, non più a mano
